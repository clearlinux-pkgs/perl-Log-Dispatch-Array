...
Source0  : https://cpan.metacpan.org/authors/id/R/RJ/RJBS/Log-Dispatch-Array-1.004.tar.gz
...
%prep
%setup -q -n Log-Dispatch-Array-1.004
cd %{_builddir}
tar xf %{_sourcedir}/liblog-dispatch-array-perl_1.003-1.debian.tar.xz
cd %{_builddir}/Log-Dispatch-Array-1.004
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Log-Dispatch-Array-1.004/deblicense/
